...
<head>
    ...
    <title>Administrator Account Activate</title>
				...
				if( mysql_num_rows($queryIndSer) == 1 )
				{
					echo "<div  id='accDecData'>
							...
							<th>" ?>
								 ...
								 <button name='accAct' id='btnDeact' alt='Activate account' title="Activate account" onclick="this.form.action='act.php' " value='<?php echo $idnum?>' >YES</button> 
